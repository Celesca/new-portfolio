  ...
  return (
    <>
        <div className="flex flex-col items-center py-24">
            ...
            <i className="nes-mario" data-aos="zoom-in-up"></i>
            <div data-aos="fade-right" className="nes-container is-dark with-title flex flex-col lg:flex-row justify-between items-center lg:justify-around w-4/6">
