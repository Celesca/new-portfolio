  ...
  return (
    <>
        <div className="flex flex-col items-center py-24">
            <h1 className="text-white text-4xl my-24" data-aos="zoom-in-up">About me</h1>
            <i className="nes-mario" data-aos="zoom-in-up" data-aos-duration="700"></i>
            <div data-aos="fade-right" data-aos-duration="1000" className="nes-container is-dark with-title flex flex-col lg:flex-row justify-between items-center lg:justify-around w-4/6">
